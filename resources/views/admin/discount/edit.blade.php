                        ...
                        <form action="{{url('admin/discounts/'.$discount->id)}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="discount_name" type="text" class="form-control mt-2" placeholder="Discount Name" value="{{old('discount_name', $discount->discount_name)}}">
                                    @error('discount_name')
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input name="discount_value" type="number" class="form-control mt-2" placeholder="Discount Value" value="{{old('discount_value', $discount->discount_value)}}">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input name="valid_from"  type="date" class="form-control mt-2" placeholder="Discount Value" value="{{old('valid_from', $discount->valid_from)}}">
                                    @error('valid_from')
                                        <div class="text-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input name="valid_to"  type="date" class="form-control mt-2" placeholder="Discount Value" value="{{old('valid_to', $discount->valid_to)}}">
                                    @error('valid_to')
                                        <div class="text-danger">{{$message}}</div>
                                    @enderror
                                </div>
