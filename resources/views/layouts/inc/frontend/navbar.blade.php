...
<style>
        ...
        .marquee-content {
            ...
            padding-left: 50%; /* start from outside */
    ...
    <div class="offers-bar">
        <div class="marquee-content">
            ...
            @foreach($ecomoffers as $offer)
                <li>🌟 <strong>{{ $offer->product_name }} </strong> {{$offer->description}} </li>
            @endforeach
        </ul>
        </div>
...
<div class="main-navbar shadow-sm sticky-top" style="margin-top: 44px;">
