                        ...
                        <form action="{{url('admin/users')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control mt-2 @error('name') is-invalid @enderror" placeholder="Enter Name">
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="email" id="" type="email" class="form-control mt-2 @error('email') is-invalid @enderror" placeholder="Enter Email">
                                    @error('email')
                                        <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="password" id="" type="password" class="form-control mt-2 @error('password') is-invalid @enderror" placeholder="Enter Password">
                                    @error('password')
                                        <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
