    ...
    <thead>
        <tr>
            <th width="50%" colspan="2">
                <h2 class="text-start">ASM Ecom</h2>
            </th>
            <th width="50%" colspan="2" class="text-end company-data">
                <span>Invoice Id: #{{ $order->id }}</span><br>
                <span>Date: {{ date('d/m/Y') }}</span><br>
                <span>Zip code: 560077</span><br>
                <span>Address: #555, Tamilnadu</span><br>
            </th>
        </tr>
...
<table>
    <thead>
        <tr>
            <th class="no-border text-start heading" colspan="6">Order Items</th>
        </tr>
        <tr class="bg-blue">
            <th>ID</th>
            <th>Product</th>
    ...
    <tbody>
        ...
        @if ($order->discount > 0)
            <tr>
                <td colspan="4" class="fw-bold text-end text-success">
                    Discount 
...
<br>
<p class="text-center">
    Thank you for shopping with ASM Ecom!
</p>
